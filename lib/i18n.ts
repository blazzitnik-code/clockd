...
export const t = {
  ...
  working: { en: "Working", sl: "Delaš" },
  earned: { en: "earned", sl: "zasluženo" },
  addHours: { en: "Add hours", sl: "Dodaj ure" },
  addHoursManually: { en: "Add hours manually", sl: "Ročno dodaj ure" },
  add: { en: "Add", sl: "Dodaj" },
  estimatedNet: { en: "estimated net", sl: "ocenjen neto" },
  moreOptions: { en: "More options (times, amount, label)", sl: "Več možnosti (ure od–do, znesek, oznaka)" },
  yesterday: { en: "Yesterday", sl: "Včeraj" },
  paidOut: { en: "paid out", sl: "izplačano" },
  paidOutTitle: { en: "Paid out", sl: "Izplačano" },
  taxAdvance: { en: "tax advance", sl: "akontacija" },
  viewBreakdown: { en: "View breakdown", sl: "Prikaži razčlenitev" },
  netCaps: { en: "NET", sl: "NETO" },
  rateType: { en: "Rate type", sl: "Vrsta postavke" },
  ...
  duration: { en: "Duration", sl: "Trajanje" },
  enterTimes: { en: "Enter start and end time", sl: "Vnesi uro začetka in konca" },
  enterDuration: { en: "Enter total time instead", sl: "Raje vnesi skupni čas" },
  rates: { en: "Hourly rate", sl: "Urna postavka" },
  newRate: { en: "New rate", sl: "Nova postavka" },
  editRate: { en: "Edit rate", sl: "Uredi postavko" },
  validFrom: { en: "Valid from", sl: "Velja od" },
  fromStart: { en: "from the start", sl: "od začetka" },
  fromDate: { en: "from", sl: "od" },
  rateNote: {
    en: "A new rate applies to entries from its date onward. Earlier entries keep the old rate.",
  ...
  deleteCompanyBody: {
    ...
    sl: "Izbriše se zgodovina postavk. Vneseni vnosi ostanejo, a brez podjetja, zato se računajo po privzeti postavki iz nastavitev.",
  },
  entriesAffected: { en: "Entries affected", sl: "Prizadetih vnosov" },
  deleteRateQ: { en: "Delete this rate?", sl: "Izbrišem to postavko?" },
  deleteRateBody: {
    en: "Entries in its period will use the previous rate instead.",
    sl: "Vnosi v tem obdobju bodo računani po prejšnji postavki.",
  },
  yesDelete: { en: "Yes, delete", sl: "Da, izbriši" },
  companyNameLabel: { en: "Name", sl: "Ime" },
  saveName: { en: "Save name", sl: "Shrani ime" },
  notHourly: { en: "not hourly", sl: "ni urno" },
